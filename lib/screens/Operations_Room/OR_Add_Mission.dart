...
class OrAddMission extends StatefulWidget {
  const OrAddMission({
    Key? key,
  }) : super(key: key);

  @override
  State<OrAddMission> createState() => _OrAddMission();
}

class _OrAddMission extends State<OrAddMission> {
  ...
  okormissoninfo(context) async {
    var id = DateTime.now().millisecondsSinceEpoch;
    CollectionReference ormissioninformation =
        FirebaseFirestore.instance.collection("or-mission-information");
    if (formState.currentState!.validate()) {
      try {
        ...
        Navigator.of(context).pushNamed("choosecenter", arguments: id);
      } catch (e) {
        print("Error  $e");
      }
    }
  ...
  rejectormissoninfo(context) async {
    var id = DateTime.now().millisecondsSinceEpoch;

    CollectionReference orrejectedmissioninformation = FirebaseFirestore
        .instance
        .collection("or-mission-rejected-information");
    if (formState.currentState!.validate()) {
      try {
        await orrejectedmissioninformation.doc(id.toString()).set({
          "name_of_the_mission_requester": name_of_the_mission_requester.text,
          "who_is_the_requester": who_is_the_requester.text,
          "number_of_mission_requester": number_of_mission_requester.text,
          "details": details.text,
        ...
        Navigator.of(context).pushNamed("addorminformation", arguments: id);
      } catch (e) {
        print("Error  $e");
      }
    }
