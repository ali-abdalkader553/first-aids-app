...
class AcceptableMissions extends StatefulWidget {
  const AcceptableMissions({
    Key? key,
  }) : super(key: key);

  @override
  State<AcceptableMissions> createState() => _AcceptableMissions();
}

class _AcceptableMissions extends State<AcceptableMissions> {
